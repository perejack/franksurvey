  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background overflow-x-hidden">
          ...
          <div className="w-full max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-base text-primary-foreground/80 mb-8 max-w-md mx-auto">
                  Sign up free and start sharing your opinions through surveys. Reward amounts vary by survey.
                </p>
                <motion.button
                  whileTap={{ scale: 0.96 }}
        ...
        <footer className="border-t border-border py-10 px-5 bg-muted/20">
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  An online survey platform connecting Kenyan voices with research opportunities. Reward amounts vary by survey and are not guaranteed.
                </p>
              </div>
              <div>
                <p className="text-xs font-bold text-foreground uppercase tracking-wider mb-3">Legal</p>
                <ul className="space-y-2">
                  ...
                  <li><Link to="/refund" className="text-xs text-muted-foreground hover:text-primary transition-colors">Refund Policy</Link></li>
                </ul>
              </div>
              <div>
                <p className="text-xs font-bold text-foreground uppercase tracking-wider mb-3">Company</p>
                <ul className="space-y-2">
                  ...
                  <li><a href="mailto:axontechnologies103@gmail.com" className="text-xs text-muted-foreground hover:text-primary transition-colors break-all">axontechnologies103@gmail.com</a></li>
                  <li><span className="text-xs text-muted-foreground">209 Lenana Road, Nairobi, 00100</span></li>
                </ul>
              </div>
            </div>
            <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3">
              <p className="text-xs text-muted-foreground">© 2026 Survey Pay. All rights reserved. Made in Kenya.</p>
              <p className="text-xs text-muted-foreground text-center sm:text-right">Earnings are not guaranteed and depend on survey availability.</p>
            </div>
          </div>
        </footer>
      </div>
